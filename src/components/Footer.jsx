...
const Footer = () => {
  ...
  return (
    <footer className="relative top-96 z-20 bg-dark lg:bg-transparent lg:min-h-[620px] lg:bg-footer  pt-20 lg:pt-32">
      <div className="container mx-auto h-full bg-black/30">
        {/* newsletter & info */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className="flex-1 lg:max-w-[170px] ">
              ...
              <div className="capitalize text-white/70">{contact.address}</div>
              <div className="capitalize text-white/70">{contact.phone}</div>
            </div>
            {/* program */}
                ...
                {hours.program.map((item, index) => {
                  return (
                    <div className="capitalize" key={index}>
                      <div>
                        <div className="text-white/70">{item.days}</div>
